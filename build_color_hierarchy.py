...
EXPLICIT_COLOR_MAP = {
    ...
    "action grape": "purple",
    "aluminum": "gray", "aluminum grey": "gray", "alumina": "gray",
    "chrome": "gray", "pure platinum": "gray", "platinum tint": "gray",
    "metallic platinum": "gray", "ice gold met": "gold",
    ...
    "light silver metallic": "gray", "dark silver metallic": "gray",
    "silver metallic": "gray", "metallic silver": "gray",
    "wonder silver": "gray", "wonder white": "cream", "wonder quartz": "tan",
    "moonbeam": "cream", "lightning": "gray", "shimmer": "gray",
    "reflection": "gray", "raincloud": "gray", "rain cloud": "gray",
...
CANONICAL_KEYWORDS = [
    ...
    # "silver" folded into "gray" (not its own canonical bucket) -- see
    # module docstring update below: average-pixel-color extraction can't
    # distinguish true metallic sheen from a shadowed neutral gray, so
    # keeping them as separate canonical buckets was creating boundary
    # noise between adjacent near-neutrals without adding real signal.
    ("silver", "gray"), ("platinum", "gray"), ("chrome", "gray"),
